...
def build_pipeline() -> StateGraph:
    ...
    # TODO: Week 3-4 添加
    workflow.add_node("app_channel", lambda s: {**s, "error": "App 通道开发中", "current_step": "error"})
    # TODO: Week 5-6 添加
    ...
    workflow.add_edge("app_channel", "parser")
...
def run_crawl(url: str | None = None, goal: str = "", app_name: str | None = None) -> dict:
    """运行采集流水线。"""
